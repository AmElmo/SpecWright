...
## OUTPUT: Single project_summary.json File

You will create **ONE file only**: `project_summary.json`
...
```
tech_lead/
  └── project_summary.json    ← Single file with all issue details
```
...
## Complete Example: project_summary.json
...
- ✅ **Single file**: `project_summary.json` only
